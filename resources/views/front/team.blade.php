    ...
    <div class="container max-w-[1130px] mx-auto flex flex-col gap-[50px] items-center">
      <div class="flex flex-col gap-[50px] items-center">
        <div class="breadcrumb flex items-center justify-center gap-[30px]">
          ...
          <p class="text-cp-light-grey last-of-type:text-cp-black last-of-type:font-semibold">Our Village Officials</p>
        </div>
        <h2 class="font-bold text-4xl leading-[45px] text-center">Moving Together for <br> Champion Cintawargi Village</h2>
      </div>
